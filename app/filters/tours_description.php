...
if (isset($_POST['param'])) {
  ...
  $description = mysqli_query($connection, "SELECT id, tour_id, title, intro, description, `action-1`, `action-2`, `action-3`, `action-4`, program_intro, residence, territory, subtitle, `lodging-1`, `lodging-2`, price, `day-title`, `day-desc` FROM routes_description WHERE tour_id = $tourId");
